...
<body class="catalogo-body">
    ...
    <header class="top-menu">
        <a href="Perfil.html">
            <div class="icon-item">
                <img src="img/perfil.png" alt="Perfil" width=""
                class="perfil-icon">
                <p>Mi Perfil</p>
            </div>
        </a>
    ...
    <main class="catalogo-layout">
        ...
        <section class="catalogo-container">
            ...
            <div class="fila-producto">
                <img src="img/pedazoQueque.png" alt="Pan de carne" class="img-producto">
                <div class="producto-card">
                    ...
                    <div class="acciones">
                        <button class="btn-agregar">
                            <img src="img/carrito.png" alt="" width="25">
                            Añadir al carrito</button>
                        <div class="cantidad">
                            <input type="number">
                        </div>
                        <button class="btn-express">
                            <img src="img/express.png" alt="" width="25">
                            Envío Express</button>
                    </div>
                </div>
            </div>
            <div class="fila-producto">
                <img src="img/alfajor.png" alt="Pan de carne" class="img-producto">
                <div class="producto-card">
                    <h3>Pan de carne</h3>
                    <p>Descripción de ingredientes</p>
                    <div class="estrellas"></div>
            ...
            <div class="fila-producto">
                <img src="img/tresleches.png" alt="Pan de carne" class="img-producto">
                <div class="producto-card">
                    <h3>Pan de carne</h3>
                    <p>Descripción de ingredientes</p>
                    <div class="estrellas"></div>
