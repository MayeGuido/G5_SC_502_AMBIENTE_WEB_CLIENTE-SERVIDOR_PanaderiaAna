...
<body>
    <header class="perfil-header">
        ...
        <a href="index.html" class="btn-home"><img src="img/inicio.png" alt="" width="30px"></a>
    </header>
    ...
    <main class="perfil-container">
        ...
        <section class="perfil-contenido" id="perfil-contenido">
            ...
            <img src="img/fondo.png" alt="Decoración" class="decor-img" />
        </section>
        ...
        <section id="favoritos" class="perfil-section" style="display:none;">
            <div class="favoritos-container">
                ...
                <div class="fav-grid">
                    <div class="fav-card">
                        <img src="img/trensa_dulce.png" alt="Trenza dulce" class="fav-img" />
                        <div class="fav-info">
                            <h3>Trenza dulce</h3>
            ...
            <div class="metodo-pago-container">
                ...
                <div class="tarjetas-pago">
                    <div class="metodo-card">
                        <img src="img/Tarjeta.png" alt="Pago con tarjeta" class="img-metodo" />
                        <h3>Pago con Tarjeta</h3>
                        <button class="btn-pago" data-metodo="Tarjeta">Seleccionar</button>
                    </div>
                    <div class="metodo-card">
                        <img src="img/sinpe-movil.png" alt="Pago por SINPE" class="img-metodo" />
                        <h3>SINPE Móvil</h3>
        ...
        <section id="productos" class="perfil-section" style="display:none;">
            <div class="inventario-container">
                ...
                <div class="producto-card">
                    <img src="assets/img/galleta.png" alt="Galleta" />
            ...
            <main class="carrito-layout">
                <section class="carrito-izquierda">
                    ...
                    <div class="carrito-productos">
                        <div class="producto">
                            <div class="imagen"><img src="img/pizzita.png"></div>
                            <div class="info">
                        ...
                        <div class="producto">
                            <div class="imagen"><img src="img/tresleches.png"></div>
                            <div class="info">
            ...
            <div class="admin-wrapper">
                ...
                <div class="admin-grid">
                    <div class="admin-card">
                        <img src="img/gestionUsuarios.png" alt="Gestión de usuarios" class="admin-icon">
                    ...
                    <div class="admin-card">
                        <img src="img/gestionProductos.png" alt="Gestión de productos" class="admin-icon">
                    ...
                    <div class="admin-card">
                        <img src="img/reporteVentas.png" alt="Reportes de ventas" class="admin-icon">
                    ...
                    <div class="admin-card">
                        <img src="img/configuracion.png" alt="Configuración del sistema" class="admin-icon">
