...
<head>
    ...
    <!-- CSS usando ruta absoluta desde la raíz del proyecto -->
...
<body>
    ...
    <header class="hero">
        ...
        <div class="hero-buttons">
            ...
            <a href="carrito.php" class="no-link">
            ...
            <a href="express.php" class="no-link">
                <div class="btn-item">
    ...
    <main>
        ...
        <section class="productos" id="listaResenas"></section>
            ...
            <div class="producto">
                <form id="formResena">
                    ...
                    <div class="info">
                        ...
                        <textarea id="comentario" name="comentario" rows="4" placeholder="Escribe tu opinión..." required></textarea>
