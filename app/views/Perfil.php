...
<body>
    <header class="perfil-header">
        ...
        <a href="../../index.php" class="btn-home">
            <img src="../../publics/img/inicio.png" alt="" width="30px">
        </a>
    ...
    <main class="perfil-container">
        ...
        <section id="metodosPago" class="perfil-section" style="display:none;">
            <div class="metodo-pago-container">
                ...
                <div class="tarjetas-pago">
                    ...
                    <div class="metodo-card">
                        <img src="../../publics/img/Efectivo.png" alt="Pago en efectivo" class="img-metodo" />
        ...
        <div id="carrito" class="perfil-section" style="display:none;">
            <main class="carrito-layout">
                <section class="carrito-izquierda">
                    ...
                    <div class="carrito-productos">
                        <div class="producto">
                            <div class="imagen">
                                <img src="../../publics/img/pizzita.png">
                            </div>
                            <div class="info">
                        ...
                        <div class="producto">
                            <div class="imagen">
                                <img src="../../publics/img/tresleches.png">
                            </div>
                            <div class="info">
        ...
        <div id="pedidos" class="perfil-section" style="display:none;">
        ...
        <div id="admin" class="perfil-section" style="display:none;">
            <div class="admin-wrapper">
                <h1 class="titulo-admin"> Panel de Administración</h1>

                <div class="admin-grid">
                    <div class="admin-card">
                        <img src="../../publics/img/gestionUsuarios.png" class="admin-icon">
                    ...
                    <div class="admin-card">
                        <img src="../../publics/img/gestionProductos.png" class="admin-icon">
                    ...
                    <div class="admin-card">
                        <img src="../../publics/img/reporteVentas.png" class="admin-icon">
                        <h3>Reportes de Ventas</h3>
                        <p>Consulta estadísticas y resultados de ventas.</p>
                        <button class="btn-admin reportes">Ver Reportes</button>
                    </div>

                    <div class="admin-card">
                        <img src="../../publics/img/configuracion.png" class="admin-icon">
        ...
        <div id="admin-usuarios" class="admin-subseccion perfil-section" style="display:none;">
        ...
        <div id="admin-productos" class="admin-subseccion perfil-section" style="display:none;">
            <button class="btn-volver">Volver</button>
            <h2>Gestión de Productos</h2>
        </div>

        <div id="admin-reportes" class="admin-subseccion perfil-section" style="display:none;">
            <button class="btn-volver">Volver</button>
            <h2>Reportes de Ventas</h2>
        </div>

        <div id="admin-config" class="admin-subseccion perfil-section" style="display:none;">
            <button class="btn-volver">Volver</button>
            <h2>Configuración del Sistema</h2>
        </div>

        <div id="contacto" class="perfil-section" style="display:none;">
            <div class="contacto-container">
                ...
                <div class="contacto-grid">
                    ...
                    <div class="contacto-info">
                        ...
                        <div class="mapa">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18" width="100%" height="250"></iframe>
                        </div>
                    </div>
